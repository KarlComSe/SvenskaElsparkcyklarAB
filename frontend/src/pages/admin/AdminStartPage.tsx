        ...
        <AuthData/>
            ...
            <div className="w-full max-w-lg p-4 mx-6 bg-white border border-gray-200 mb-10 rounded-lg shadow">
                <div className="flex flex-col items-center pb-10">
                    ...
                    <h5 className="mb-1 text-xl font-medium text-gray-900"> Se överblick av alla elsparkcyklar</h5>
            ...
            <div className="w-full max-w-lg p-4 mx-6 bg-white border border-gray-200 rounded-lg shadow">
                <div className="flex flex-col items-center pb-10">
                    ...
                    <h5 className="mb-1 text-xl font-medium text-gray-900">Kund information</h5>
                    <span className="text-sm text-gray-500">Se över alla kunders profiler och saldo</span>
                    <div className="flex mt-4 md:mt-6">
