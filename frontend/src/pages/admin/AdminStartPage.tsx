...
const AdminStartPage: React.FC = () => {
  ...
  return (
        <div className='flex flex-col items-center'>
            <AdminGate/>
            <div className="w-full max-w-lg p-4 mx-6 bg-white border border-gray-200 mb-10 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="w-full max-w-lg p-4 mx-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div className="flex flex-col items-center pb-10">
                    ...
                    <span className="text-sm text-gray-500 dark:text-gray-400">Se över alla kunders profiler och saldo</span>
                    <div className="flex mt-4 md:mt-6">
